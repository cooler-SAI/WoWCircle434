...
UPDATE `creature` SET `id`=51989 WHERE `id`=14451;
UPDATE `creature_template` SET `AIName`='SmartAI',`ScriptName`='' WHERE `entry`=51989;

DELETE FROM `smart_scripts` WHERE `entryorguid`=51989 AND `source_type`=0;
INSERT INTO `smart_scripts`(`entryorguid`,`id`,`link`,`event_type`,`event_param1`,`event_param2`,`action_type`,`action_param1`,`target_type`,`comment`) VALUES
(51989,1,2,62,5848,1,11,23125,7,'Orphan Matron Battlewail - On gossip select - Create orc orphan whistle'),
(51989,2,0,61,0,0,72,0,7,'Orphan Matron Battlewail - On gossip select - Close gossip');
...
UPDATE `creature_template` SET `AIName`='SmartAI',`ScriptName`='' WHERE `entry`=51988;
UPDATE `creature` SET `id`=51988 WHERE `id`=14450;

DELETE FROM `smart_scripts` WHERE `entryorguid`=51988 AND `source_type`=0;
INSERT INTO `smart_scripts`(`entryorguid`,`id`,`link`,`event_type`,`event_param1`,`event_param2`,`action_type`,`action_param1`,`target_type`,`comment`) VALUES
(51988,1,2,62,5849,1,11,23124,7,'Orphan Matron Nightingale - On gossip select - Create human orphan whistle'),
(51988,2,0,61,0,0,72,0,7,'Orphan Matron Nightingale - On gossip select - Close gossip');
...
UPDATE `quest_template` SET `Flags` = `Flags`|65536 WHERE `Id` in (29117,29119,29107,29093,29106);
UPDATE `quest_template` SET `PrevQuestId` = 1468,`ExclusiveGroup` = -29106 WHERE `Id` in (29093,29107,29106);
UPDATE `quest_template` SET `PrevQuestId` = 29106,`ExclusiveGroup` = -29117 WHERE `Id` in (29119,29117);

DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId` IN (19,20) AND `SourceEntry` IN (29117,29119,171);
INSERT INTO `conditions`(`SourceTypeOrReferenceId`,`SourceEntry`,`ConditionTypeOrReference`,`ConditionValue1`,`comment`) VALUES
(19,29119,8,29093,'Accept quest 29119 - Quest 29093 needs to be rewarded'),
(19,29119,8,29107,'Accept quest 29119 - Quest 29107 needs to be rewarded'),
(19,29119,8,29106,'Accept quest 29119 - Quest 29106 needs to be rewarded'),
(19,29119,16,2098253,'Accept quest 29119 - Needs to be in race mask 2098253'),
(19,29117,8,29093,'Accept quest 29117 - Quest 29093 needs to be rewarded'),
(19,29117,8,29107,'Accept quest 29117 - Quest 29107 needs to be rewarded'),
(19,29117,8,29106,'Accept quest 29117 - Quest 29106 needs to be rewarded'),
(19,171,8,29117,'Accept quest 171 - Quest 29117 needs to be rewarded'),
(20,29119,8,29093,'Show quest mark 29119 - Quest 29093 needs to be rewarded'),
(20,29119,8,29107,'Show quest mark 29119 - Quest 29107 needs to be rewarded'),
(20,29119,8,29106,'Show quest mark 29119 - Quest 29106 needs to be rewarded'),
(20,29119,16,2098253,'Show quest mark 29119 - Needs to be in race mask 2098253'),
(20,29117,8,29093,'Show quest mark 29117 - Quest 29093 needs to be rewarded'),
(20,29117,8,29107,'Show quest mark 29117 - Quest 29107 needs to be rewarded'),
(20,29117,8,29106,'Show quest mark 29117 - Quest 29106 needs to be rewarded'),
(20,171,8,29117,'Show quest mark 171 - Quest 29117 needs to be rewarded');
...
INSERT INTO `conditions`(`SourceTypeOrReferenceId`,`SourceEntry`,`ConditionTypeOrReference`,`ConditionValue1`,`comment`) VALUES
(19,29190,8,29146,'Accept quest 29190 - Quest 29146 needs to be rewarded'),
(19,29190,8,29167,'Accept quest 29190 - Quest 29167 needs to be rewarded'),
(19,29190,8,29176,'Accept quest 29190 - Quest 29176 needs to be rewarded'),
(19,29191,8,29146,'Accept quest 29191 - Quest 29146 needs to be rewarded'),
(19,29191,8,29167,'Accept quest 29191 - Quest 29167 needs to be rewarded'),
(19,29191,8,29176,'Accept quest 29191 - Quest 29176 needs to be rewarded'),
(19,5502,8,29190,'Accept quest 5502 - Quest 29190 needs to be rewarded'),
(20,29190,8,29146,'Show quest mark 29190 - Quest 29146 needs to be rewarded'),
(20,29190,8,29167,'Show quest mark 29190 - Quest 29167 needs to be rewarded'),
(20,29190,8,29176,'Show quest mark 29190 - Quest 29176 needs to be rewarded'),
(20,29191,8,29146,'Show quest mark 29191 - Quest 29146 needs to be rewarded'),
(20,29191,8,29167,'Show quest mark 29191 - Quest 29167 needs to be rewarded'),
(20,29191,8,29176,'Show quest mark 29191 - Quest 29176 needs to be rewarded'),
(20,5502,8,29190,'Show quest mark 5502 - Quest 29190 needs to be rewarded');
...
WHERE `id` IN (22905,22851,22838,22866,22831,22829,22872,22839,14450,51988,22819,14451,51989,34365,34387,34386,34490,34489,34381,36209);
INSERT INTO `game_event_creature`(`eventEntry`,`guid`) SELECT 10,`guid` FROM `creature` 
WHERE `id` IN (22905,22851,22838,22866,22831,22829,22872,22839,51988,22819,51989,34365,34387,34386,34490,34489,34381,36209);
