...
enum UnitMods
{
    ...
    UNIT_MOD_POWER_END = UNIT_MOD_ALTERNATE_POWER + 1
};
...
class Unit : public WorldObject
{
    public:
        ...
        bool IsFullPower()  const { return GetMaxPower(getPowerType()) == GetPower(getPowerType()); }
        ...
        uint32 GetDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_TAKEN_ALL, 1.2f, 100.0f, damage); }
        ...
        bool IsPolymorphed(bool forMount = false) const;
        ...
        */
        ...
        int32 CalcSpellDuration(SpellInfo const* spellProto, Unit* target = NULL);
    ...
    private:
        ...
        bool HandleAuraProc(Unit* victim, uint32 damage, uint32 absorb, Aura* triggeredByAura, SpellInfo const* procSpell, uint32 procFlag, uint32 procEx, uint32 cooldown, bool * handled);
