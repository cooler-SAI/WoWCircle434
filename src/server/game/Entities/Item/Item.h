...
#ifndef CERBERCORE_ITEM_H
#define CERBERCORE_ITEM_H
...
class Item : public Object
{
    public:
        ...
        void SetItemRandomProperties(int32 randomPropId, bool save = true);
        void UpdateItemSuffixFactor();
        static int32 GenerateItemRandomPropertyId(uint32 item_id);
        void SetEnchantment(EnchantmentSlot slot, uint32 id, uint32 duration, uint32 charges, bool save = true);
