...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SendCategoryCooldown(uint32 categoryId, uint32 cooldown);
        ...
        void UpdateMasteryDependentBuffs(uint32 spellId, bool updatePet = false);
        ...
        void UpdateGuildAchievementCriteria(AchievementCriteriaTypes type, uint32 miscValue1 = 0, uint32 miscValue2 = 0, Unit* unit = NULL);
