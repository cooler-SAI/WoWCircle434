...
// 2^n values, Player::m_isunderwater is a bitmask. These are CerberCore internal values, they are never send to any client
...
#define MAX_MONEY_FOR_MAIL             4000000000 
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SendBuyError(BuyResult msg, uint64 guid, uint32 item);
        ...
        uint32 GetPrimaryTalentTreeForCurrentSpec() const { return _talentMgr->SpecInfo[_talentMgr->ActiveSpec].TalentTree; }
        ...
        void RemoveSpellCooldown(SpellCooldowns::iterator itr, bool update = false, bool manySpells = false);
        ...
        void SetSpellPenetrationItemMod(bool apply, int32 val);
        ...
        uint8 GetMasteryScalingValue(SpellInfo const* spellInfo, int32& amount) const;
        float GetMastery() const { return GetFloatValue(PLAYER_MASTERY); }
        void UpdateMasteryDependentBuffs(uint32 spellId);
        ...
        /***                 VARIOUS SYSTEMS                   ***/
        /*********************************************************/
        void UpdateFallInformationIfNeed(MovementInfo const& minfo);
        Unit* m_mover;
        WorldObject* m_seer;
        ...
        GroupUpdateFlags GetGroupUpdateFlag() const { return m_groupUpdateMask; }
        void SetGroupUpdateFlag(GroupUpdateFlags flag) { m_groupUpdateMask |= flag; }
