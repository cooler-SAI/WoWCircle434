...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Welcome to a CerberCore Core Server."));
    ...
    m_int_configs[CONFIG_EXTERNAL_MAIL] = ConfigMgr::GetIntDefault("ExternalMail", 1);
    m_int_configs[CONFIG_EXTERNAL_MAIL_INTERVAL] = ConfigMgr::GetIntDefault("ExternalMailInterval", 5);
    ...
    Visibility_RelocationLowerLimit = ConfigMgr::GetFloatDefault("Visibility.RelocationLowerLimit", 10.f);
    ...
    m_bool_configs[CONFIG_LFG_CASTDESERTER] = ConfigMgr::GetBoolDefault("DungeonFinder.CastDeserter", false);
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading CerberCore strings...");
    if (!sObjectMgr->LoadCerberCoreStrings())
    ...
    extmail_timer.SetInterval(getIntConfig(CONFIG_EXTERNAL_MAIL_INTERVAL) * MINUTE * IN_MILLISECONDS);
                                                            //1440
...
void World::SendWorldText(int32 string_id, ...)
{
    ...
    CerberCore::WorldWorldTextBuilder wt_builder(string_id, &ap);
    CerberCore::LocalizedPacketListDo<CerberCore::WorldWorldTextBuilder> wt_do(wt_builder);
...
void World::SendAutoBroadcast()
{
    ...
    std::string msg = CerberCore::Containers::SelectRandomContainerElement(m_Autobroadcasts);
