...
enum WorldBoolConfigs
{
    ...
    CONFIG_DATABASE_SKIP_LOAD_LOOT,
    ...
    CONFIG_IS_TOURNAMENT_REALM,
    CONFIG_IS_TRIAL_ACCOUNTS,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CURRENCY_RESET_CAP_TIMEOUT,
    CONFIG_CURRENCY_RESET_CAP_PLAYERS_COUNT,
