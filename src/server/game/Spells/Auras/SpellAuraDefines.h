 ...
 */
#ifndef CERBERCORE_SPELLAURADEFINES_H
#define CERBERCORE_SPELLAURADEFINES_H
...
enum AuraType
{
    ...
    SPELL_AURA_MOD_RANGED_HASTE_2                           = 218,
    ...
    SPELL_AURA_CAN_SEE_OR_DETECT_STEALTH                    = 335,
    ...
    SPELL_AURA_MOD_SPELL_CATEGORY_COOLDOWN                  = 341,  // Reduction category cooldown on item spells
    ...
    SPELL_AURA_351                                          = 351,
    SPELL_AURA_WORGEN_CAN_TRANSFORM                         = 352,
