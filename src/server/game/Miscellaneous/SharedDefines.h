...
#ifndef CERBERCORE_SHAREDDEFINES_H
#define CERBERCORE_SHAREDDEFINES_H
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_STOPS_AUTOATTACK                 = 0x00800000, // 23
...
enum SpellAttr8
{
    ...
    SPELL_ATTR8_AURA_PER_CASTER                  = 0x00002000, // 13
    SPELL_ATTR8_UNK14                            = 0x00004000, // 14
    SPELL_ATTR8_WATER_MOUNT                      = 0x00008000, // 15
    ...
    SPELL_ATTR8_UNK22                            = 0x00400000, // 22 some healing auras have this flag
    SPELL_ATTR8_BATTLE_RESURRECTION              = 0x00800000, // For those resurrection spells that can be used in combat
    ...
    SPELL_ATTR8_NOT_IN_BG_OR_ARENA               = 0x10000000, // 28
...
enum SpellAttr10
{
    ...
    SPELL_ATTR10_TELEPORT_PLAYER                  = 0x00000080, // 7
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_RESURRECT_WITH_AURA                = 172, // Aoe ressurection
...
enum DiminishingGroup
{
    ...
    DIMINISHING_RANDOM_ROOT         = 12,
    DIMINISHING_RANDOM_STUN         = 13,
...
enum GroupUpdateFlags
{
    ...
    GROUP_UPDATE_PLAYER = GROUP_UPDATE_FLAG_CUR_HP |
