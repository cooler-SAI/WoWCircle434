...
#ifndef CERBERCORE_CHAT_H
#define CERBERCORE_CHAT_H
...
class ChatHandler
{
    public:
        ...
        virtual const char *GetCerberCoreString(int32 entry) const;
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        const char *GetCerberCoreString(int32 entry) const;
