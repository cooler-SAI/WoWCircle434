...
void SmartWaypointMgr::LoadFromDB()
{
    ...
    PreparedStatement* stmt = WorldDatabase.GetPreparedStatement<0>(WORLD_SEL_SMARTAI_WP);
...
void SmartAIMgr::LoadSmartAIFromDB()
{
    ...
    PreparedStatement* stmt = WorldDatabase.GetPreparedStatement<0>(WORLD_SEL_SMART_SCRIPTS);
    PreparedQueryResult result = WorldDatabase.Query(stmt);
