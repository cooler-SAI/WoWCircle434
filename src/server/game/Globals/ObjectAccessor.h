...
#ifndef CERBERCORE_OBJECTACCESSOR_H
#define CERBERCORE_OBJECTACCESSOR_H
...
class HashMapHolder
{
    public:
        ...
        {
            CERBERCORE_WRITE_GUARD(LockType, i_lock);
        ...
        {
            CERBERCORE_READ_GUARD(LockType, i_lock);
...
class ObjectAccessor
{
    ...
    public:
        ...
        template<class T> static T* GetObjectInWorld(uint32 mapid, float x, float y, uint64 guid, T* /*fake*/)
        {
            ...
            CellCoord q = CerberCore::ComputeCellCoord(obj->GetPositionX(), obj->GetPositionY());
            if (!q.IsCoordValid())
            {
        ...
        {
            CERBERCORE_GUARD(ACE_Thread_Mutex, i_objectLock);
