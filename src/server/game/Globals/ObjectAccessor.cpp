...
{
    CERBERCORE_READ_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        CERBERCORE_WRITE_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
        ...
        CellCoord cellCoord = CerberCore::ComputeCellCoord(corpse->GetPositionX(), corpse->GetPositionY());
