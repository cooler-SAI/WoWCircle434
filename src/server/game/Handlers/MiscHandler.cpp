...
void WorldSession::HandleAddFriendOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement<1>(CHAR_SEL_GUID_RACE_ACC_BY_NAME);
...
void WorldSession::HandleBugOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement<2>(CHAR_INS_BUG_REPORT);
    ...
    else
    {
        switch (type)
        {
            ...
            case ACTION_BUTTON_ITEM:
                ...
                break;
            case ACTION_BUTTON_MULTISPELL:
                sLog->outInfo(LOG_FILTER_NETWORKIO, "MISC: Added Multispell %u into button %u", action, button);
                break;
            default:
...
void WorldSession::HandleWhoisOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = LoginDatabase.GetPreparedStatement<1>(LOGIN_SEL_ACCOUNT_WHOIS);
