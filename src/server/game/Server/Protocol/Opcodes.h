...
enum Opcodes
{
    ...
    CMSG_ACCEPT_LEVEL_GRANT                           = 0x0205, // 4.3.4
    CMSG_ACCEPT_TRADE                                 = 0x7110, // 4.3.4
    CMSG_ACTIVATETAXI                                 = 0x6E06, // 4.3.4
    CMSG_ACTIVATETAXIEXPRESS                          = 0x0515, // 4.3.4
    CMSG_ADDON_REGISTERED_PREFIXES                    = 0x0954, // 4.3.4
    CMSG_ADD_FRIEND                                   = 0x6527, // 4.3.4
    CMSG_ADD_IGNORE                                   = 0x4726, // 4.3.4
    CMSG_ADD_VOICE_IGNORE                             = 0x0F06, // 4.3.4
    CMSG_ALTER_APPEARANCE                             = 0x0914, // 4.3.4
    CMSG_AREATRIGGER                                  = 0x0937, // 4.3.4
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x4907, // 4.3.4
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x4815, // 4.3.4
    CMSG_ARENA_TEAM_ACCEPT                            = 0x2A25, // 4.3.4
    CMSG_ARENA_TEAM_CREATE                            = 0x04A1, // 4.3.4
    CMSG_ARENA_TEAM_DECLINE                           = 0x6925, // 4.3.4
    ...
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x51A6, // 4.3.4
    SMSG_VOID_TRANSFER_RESULT                         = 0x1DA6, // 4.3.4
    SMSG_WAIT_QUEUE_FINISH                            = 0x75B7, // 4.3.4
    SMSG_WAIT_QUEUE_UPDATE                            = 0x58A1, // 4.3.4
    SMSG_WARDEN_DATA                                  = 0x31A0, // 4.3.4
    SMSG_WARGAME_CHECK_ENTRY                          = 0x3DA4, // 4.3.4
    SMSG_WARGAME_REQUEST_SENT                         = 0x59B2, // 4.3.4
    SMSG_WEATHER                                      = 0x2904, // 4.3.4
    SMSG_WEEKLY_LAST_RESET                            = 0x50A5, // 4.3.4 uint32
    SMSG_WEEKLY_RESET_CURRENCY                        = 0x3CA1, // 4.3.4
    SMSG_WEEKLY_SPELL_USAGE                           = 0x39B7, // 4.3.4 sub_6DEA10
    SMSG_WEEKLY_SPELL_USAGE_UPDATE                    = 0x11B5, // 4.3.4 sub_6AEF10
    SMSG_WHO                                          = 0x6907, // 4.3.4
    SMSG_WHOIS                                        = 0x6917, // 4.3.4
    SMSG_WORLD_SERVER_INFO                            = 0x31A2, // 4.3.4
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                  = 0x4A14, // 4.3.4
    SMSG_XP_GAIN_ABORTED                              = 0x50B4, // 4.3.4
    SMSG_ZONE_UNDER_ATTACK                            = 0x0A06, // 4.3.4
    SMSG_SPLINE_MOVE_SET_ANIM                         = 0x4335, // 4.3.4
    SMSG_UNKNOWN_1240                                 = 0x4C05, // 4.3.4 should have name changed - WPP
