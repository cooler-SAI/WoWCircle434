...
enum Opcodes
{
    ...
    CMSG_BATTLEFIELD_REQUEST_SCORE_DATA               = UNKNOWN_OPCODE,
    ...
    CMSG_BOT_DETECTED2                                = UNKNOWN_OPCODE,
    CMSG_BUG                                          = 0x4035,
    ...
    CMSG_CALENDAR_CONTEXT_EVENT_SIGNUP                = UNKNOWN_OPCODE,
    ...
    CMSG_CANCEL_GROWTH_AURA                           = UNKNOWN_OPCODE,
    ...
    CMSG_DECLINE_CHANNEL_INVITE                       = UNKNOWN_OPCODE,
    ...
    CMSG_EQUIPMENT_SET_DELETE                         = UNKNOWN_OPCODE,
    ...
    CMSG_GAMESPEED_SET                                = UNKNOWN_OPCODE,
    CMSG_GAMETIME_SET                                 = UNKNOWN_OPCODE,
    CMSG_GETDEATHBINDZONE                             = UNKNOWN_OPCODE,
    CMSG_GET_MAIL_LIST                                = 0x4D37,
    CMSG_GET_MIRRORIMAGE_DATA                         = 0x0C25,
    CMSG_GHOST                                        = UNKNOWN_OPCODE,
    ...
    CMSG_GROUP_UNINVITE                               = UNKNOWN_OPCODE,
    ...
    CMSG_GUILD_BANK_NOTE                              = UNKNOWN_OPCODE,
    ...
    CMSG_GUILD_INFO                                   = UNKNOWN_OPCODE,
    CMSG_GUILD_INFO_TEXT                              = 0x3227,
    CMSG_GUILD_INVITE                                 = 0x24B0,
    CMSG_GUILD_LEADER                                 = UNKNOWN_OPCODE,
    ...
    CMSG_MEETINGSTONE_INFO                            = UNKNOWN_OPCODE,
    ...
    CMSG_PET_NAME_CACHE                               = UNKNOWN_OPCODE,
    ...
    CMSG_PLAYER_DIFFICULTY_CHANGE                     = UNKNOWN_OPCODE,
    CMSG_PLAYER_LOGIN                                 = 0x05B1,
    CMSG_PLAYER_LOGOUT                                = UNKNOWN_OPCODE,
    ...
    CMSG_QUESTGIVER_CANCEL                            = UNKNOWN_OPCODE,
    ...
    CMSG_QUESTGIVER_QUEST_AUTOLAUNCH                  = UNKNOWN_OPCODE,
    ...
    CMSG_QUESTLOG_SWAP_QUEST                          = UNKNOWN_OPCODE,
    ...
    CMSG_REPLACE_ACCOUNT_DATA                         = UNKNOWN_OPCODE,
    ...
    CMSG_SAVE_PLAYER                                  = UNKNOWN_OPCODE,
    CMSG_SEARCH_LFG_JOIN                              = UNKNOWN_OPCODE,
    CMSG_SEARCH_LFG_LEAVE                             = UNKNOWN_OPCODE,
    ...
    CMSG_SERVERTIME                                   = UNKNOWN_OPCODE,
    CMSG_SETDEATHBINDPOINT                            = UNKNOWN_OPCODE,
    ...
    CMSG_SET_SKILL_CHEAT                              = UNKNOWN_OPCODE,
    ...
    CMSG_START_QUEST                                  = UNKNOWN_OPCODE,
    CMSG_STOP_DANCE                                   = 0x2907,
    CMSG_STORE_LOOT_IN_SLOT                           = UNKNOWN_OPCODE,
    ...
    CMSG_TAXICLEARALLNODES                            = UNKNOWN_OPCODE,
    CMSG_TAXIENABLEALLNODES                           = UNKNOWN_OPCODE,
    CMSG_TAXINODE_STATUS_QUERY                        = 0x2F25,
    CMSG_TAXIQUERYAVAILABLENODES                      = 0x6C06,
    CMSG_TAXISHOWNODES                                = UNKNOWN_OPCODE,
    ...
    CMSG_TRIGGER_CINEMATIC_CHEAT                      = UNKNOWN_OPCODE,
    ...
    MSG_GM_BIND_OTHER                                 = UNKNOWN_OPCODE,
    MSG_GM_SHOWLABEL                                  = UNKNOWN_OPCODE,
    MSG_GM_SUMMON                                     = UNKNOWN_OPCODE,
    ...
    MSG_MOVE_FEATHER_FALL                             = UNKNOWN_OPCODE,
    MSG_MOVE_GRAVITY_CHNG                             = UNKNOWN_OPCODE,
    MSG_MOVE_HEARTBEAT                                = 0x3914,
    MSG_MOVE_HOVER                                    = UNKNOWN_OPCODE,
    MSG_MOVE_JUMP                                     = 0x7A06,
    MSG_MOVE_SET_ALL_SPEED_CHEAT                      = UNKNOWN_OPCODE,
    MSG_MOVE_SET_COLLISION_HEIGHT                     = UNKNOWN_OPCODE,
    MSG_MOVE_SET_FACING                               = 0x7914,
    MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                   = UNKNOWN_OPCODE,
    MSG_MOVE_SET_PITCH                                = 0x7312,
    MSG_MOVE_SET_RAW_POSITION_ACK                     = UNKNOWN_OPCODE,
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                 = UNKNOWN_OPCODE,
    MSG_MOVE_SET_RUN_MODE                             = 0x791A,
    MSG_MOVE_SET_RUN_SPEED_CHEAT                      = UNKNOWN_OPCODE,
    MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT                = UNKNOWN_OPCODE,
    MSG_MOVE_SET_SWIM_SPEED_CHEAT                     = UNKNOWN_OPCODE,
    MSG_MOVE_SET_TURN_RATE_CHEAT                      = UNKNOWN_OPCODE,
    MSG_MOVE_SET_WALK_MODE                            = 0x7002,
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = UNKNOWN_OPCODE,
    ...
    MSG_MOVE_TOGGLE_FALL_LOGGING                      = UNKNOWN_OPCODE,
    MSG_MOVE_TOGGLE_LOGGING                           = UNKNOWN_OPCODE,
    MSG_MOVE_UPDATE_CAN_FLY                           = UNKNOWN_OPCODE,
    MSG_MOVE_UPDATE_FLIGHT_SPEED                      = 0x30B1,
    MSG_MOVE_UPDATE_MOUSE                             = UNKNOWN_OPCODE,
    MSG_MOVE_UPDATE_RUN_SPEED                         = 0x14A6,
    MSG_MOVE_UPDATE_TELEPORT                          = 0x50B2,
    MSG_MOVE_WATER_WALK                               = UNKNOWN_OPCODE,
    ...
    MSG_PVP_LOG_DATA                                  = UNKNOWN_OPCODE,
    ...
    MSG_START_MOVE_FORWARD                            = UNKNOWN_OPCODE,
    ...
    SMSG_AURACASTLOG                                  = UNKNOWN_OPCODE,
    ...
    SMSG_BINDZONEREPLY                                = UNKNOWN_OPCODE,
    SMSG_BREAK_TARGET                                 = 0x0105,
    SMSG_BUY_BANK_SLOT_RESULT                         = UNKNOWN_OPCODE,
    SMSG_BUY_FAILED                                   = 0x6435,
    SMSG_BUY_ITEM                                     = 0x0F26,
    SMSG_CALENDAR_ACTION_PENDING                      = UNKNOWN_OPCODE,
    ...
    SMSG_CALENDAR_UPDATE_INVITE_LIST                  = UNKNOWN_OPCODE,
    ...
    SMSG_CHECK_FOR_BOTS                               = UNKNOWN_OPCODE,
    ...
    SMSG_COMBAT_LOG_MULTIPLE                          = UNKNOWN_OPCODE,
    ...
    SMSG_DAMAGE_DONE_OBSOLETE                         = UNKNOWN_OPCODE,
    ...
    SMSG_FORCEACTIONSHOW                              = UNKNOWN_OPCODE,
    SMSG_FORCED_DEATH_UPDATE                          = 0x2606,
    SMSG_FORCE_DISPLAY_UPDATE                         = UNKNOWN_OPCODE,
    ...
    SMSG_GUILD_CANCEL                                 = UNKNOWN_OPCODE,
    ...
    SMSG_GUILD_SET_NOTE                               = UNKNOWN_OPCODE,
    SMSG_GUILD_TRADESKILL_UPDATE                      = UNKNOWN_OPCODE,
    SMSG_GUILD_UPDATE_ROSTER                          = 0x18B0,
    SMSG_GUILD_XP                                     = 0x3DB0,
    SMSG_GUILD_XP_GAIN                                = 0x14A1,
    SMSG_GUILD_XP_UPDATE                              = UNKNOWN_OPCODE,
    ...
    SMSG_INSTANCE_DIFFICULTY                          = UNKNOWN_OPCODE,
    ...
    SMSG_JOINED_BATTLEGROUND_QUEUE                    = UNKNOWN_OPCODE,
    ...
    SMSG_LFG_UPDATE_LIST                              = UNKNOWN_OPCODE,
    SMSG_LFG_UPDATE_PARTY                             = UNKNOWN_OPCODE,
    SMSG_LFG_UPDATE_PLAYER                            = UNKNOWN_OPCODE,
    ...
    SMSG_MEETINGSTONE_MEMBER_ADDED                    = UNKNOWN_OPCODE,
    SMSG_MEETINGSTONE_SETQUEUE                        = UNKNOWN_OPCODE,
    ...
    SMSG_MOVE_DISABLE_GRAVITY                         = UNKNOWN_OPCODE,
    SMSG_MOVE_ENABLE_COLLISION                        = UNKNOWN_OPCODE,
    SMSG_MOVE_ENABLE_GRAVITY                          = UNKNOWN_OPCODE,
    ...
    SMSG_MOVE_SET_WALK_IN_AIR                         = UNKNOWN_OPCODE,
    ...
    SMSG_MOVE_UNSET_WALK_IN_AIR                       = UNKNOWN_OPCODE,
    ...
    SMSG_NPC_WONT_TALK                                = UNKNOWN_OPCODE,
    ...
    SMSG_PLAYER_UNK_DEAD_ALIVE                        = UNKNOWN_OPCODE,
    ...
    SMSG_PUREMOUNT_CANCELLED_OBSOLETE                 = UNKNOWN_OPCODE,
    ...
    SMSG_QUESTUPDATE_ADD_ITEM                         = UNKNOWN_OPCODE,
    ...
    SMSG_SPLINE_MOVE_SET_WATER_WALK                   = UNKNOWN_OPCODE,
