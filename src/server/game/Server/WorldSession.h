...
class WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void Handle_NULL(WorldPacket& recvPacket);          // not used with log
        ...
        void BuildMoveUpdatePacket(Unit* mover, MovementInfo& movementInfo, size_t size, Player* skip = NULL) const;
