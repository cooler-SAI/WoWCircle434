...
#ifndef CERBERCORE_GRIDDEFINES_H
#define CERBERCORE_GRIDDEFINES_H
...
typedef TYPELIST_4(Creature/*except pets*/, GameObject, DynamicObject, Corpse/*Bones*/) AllGridObjectTypes;
