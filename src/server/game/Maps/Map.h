...
#ifndef CERBERCORE_MAP_H
#define CERBERCORE_MAP_H
...
class MapInstanced;
class InstanceMap;
namespace CerberCore { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<CerberCore::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<CerberCore::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(CerberCore::ComputeGridCoord(x, y));
        }
