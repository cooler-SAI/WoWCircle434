...
#ifndef CERBERCORE_DBCSTRUCTURE_H
#define CERBERCORE_DBCSTRUCTURE_H
...
{
    uint32 ID;                                              // 0        not used (oh seriosly)
...
struct TalentTabEntry
{
    ...
    uint32 spellIds[MAX_MASTERY_SPELL];                     // 9-10 passive mastery bonus spells
};
