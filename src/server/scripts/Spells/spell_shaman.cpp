...
class spell_sha_fire_nova : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_fire_nova_SpellScript : public SpellScript
        {
            ...
            {
                UnitList targets;
                CerberCore::AnyUnitHavingBuffInObjectRangeCheck u_check(GetCaster(), GetCaster(), 100, SHAMAN_SPELL_FLAME_SHOCK, false);
                CerberCore::UnitListSearcher<CerberCore::AnyUnitHavingBuffInObjectRangeCheck> searcher(GetCaster(), targets, u_check);
    ...
    public:
        ...
        class spell_sha_bloodlust_SpellScript : public SpellScript
        {
            ...
            void RemoveInvalidTargets(std::list<WorldObject*>& targets)
            {
                ...
                targets.remove_if(CerberCore::UnitAuraCheck(true, MAGE_SPELL_TEMPORAL_DISPLACEMENT));
            }
