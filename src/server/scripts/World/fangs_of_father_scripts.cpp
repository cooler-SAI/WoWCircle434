...
class npc_mostrasz_56314 : public CreatureScript
{
    public:
        ...
        bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*sender*/, uint32 /*action*/)
        {
            ...
            if (pPlayer->GetQuestStatus(QUEST_TO_RAVENHOLDT) == QUEST_STATUS_INCOMPLETE)
            {
                pPlayer->KilledMonsterCredit(56314, 0);
                pPlayer->TeleportTo(0, 14.685211f, -1463.118896f, 173.92f, 6.23f);
            }
...
class npc_wrathion_57777 : public CreatureScript
{
    public:
        ...
        {
            return new npc_wrathion_57777AI(pCreature);
        }

        struct npc_wrathion_57777AI : ScriptedAI
        {
            npc_wrathion_57777AI(Creature* pCreature) : ScriptedAI(pCreature) 
            {
            }
...
class npc_lord_hiram_creed : public CreatureScript
{
    public:
        ...
        {
            npc_lord_hiram_creedAI(Creature* pCreature) : ScriptedAI(pCreature) 
            {
