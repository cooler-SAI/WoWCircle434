        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                CerberCore::AllWorldObjectsInRange objects(me, searchDistance);
                CerberCore::WorldObjectListSearcher<CerberCore::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
