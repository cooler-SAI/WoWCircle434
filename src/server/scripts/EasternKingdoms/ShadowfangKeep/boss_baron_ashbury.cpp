...
class boss_baron_ashbury : public CreatureScript
{
    public:
     ...
     {
        boss_baron_ashburyAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
        ...
        void Reset()
        {
            ...
            bCombo = false;
            bHeal = false;
            pInstance->SetData(DATA_ASHBURY, NOT_STARTED);
            events.Reset();
        }
        ...
        void EnterCombat(Unit* pWho)
        {
            ...
            DoZoneInCombat();
            pInstance->SetData(DATA_ASHBURY, IN_PROGRESS);
        }
        ...
        void JustDied(Unit* pWho)
        {
            ...
            pInstance->DoRemoveAurasDueToSpellOnPlayers(SPELL_WRACKING_PAIN);
            pInstance->SetData(DATA_ASHBURY, DONE);
        }
