    ...
    public:
     ...
     struct boss_commander_springvaleAI : public ScriptedAI
     {
        ...
        void Reset()
        {
            ...
            pInstance->SetData(DATA_SPRINGVALE, NOT_STARTED);
            summons.DespawnAll();
            events.Reset();
        }
        void EnterCombat(Unit* pWho)
        {
            ...
            pInstance->SetData(DATA_SPRINGVALE, IN_PROGRESS);
        ...
        void JustSummoned(Creature* summon)
        {
            ...
            {
            case NPC_SPRINGVALE_OFFICER:
            case NPC_SPRINGVALE_GUARD:
        ...
        void JustDied(Unit* pWho)
        {
            ...
            summons.DespawnAll();
            pInstance->SetData(DATA_SPRINGVALE, DONE);
        ...
        void UpdateAI(const uint32 uiDiff)
        {
            ...
            while(uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_UNHOLY_EMPOWERMENT:
                    if (Creature* springvale = Unit::GetCreature(*me, pInstance->GetData64(DATA_SPRINGVALE)))
