    ...
    public:
        ...
        struct npc_neptulonAI : public ScriptedAI
        {
            ...
            void CompleteEncounter()
            {
                ...
                {
                    // Achievement
                    pInstance->DoUpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET, SPELL_KILL_OZUMAT, 0, NULL); 
                        ...
                        for (Map::PlayerList::const_iterator i = PlayerList.begin(); i != PlayerList.end(); ++i)
                        {
                            if (Player* pPlayer = i->getSource())
                                if (Group* pGroup = pPlayer->GetGroup())
                                    ...
                                    {
                                        pGroup->UpdateGuildAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET, SPELL_KILL_OZUMAT, 0, NULL, me);
                                        break;
                                    }
                        }
                    }
