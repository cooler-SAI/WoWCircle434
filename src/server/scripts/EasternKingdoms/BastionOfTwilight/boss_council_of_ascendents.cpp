...
enum Spells
{
    ...
    SPELL_AEGIS_OF_FLAMES_25    = 92512,
    SPELL_AEGIS_OF_FLAMES_10H    = 92513,
    SPELL_AEGIS_OF_FLAMES_25H    = 92514,
    ...
    SPELL_LIGHTNING_BLAST_25    = 92454,
    SPELL_LIGHTNING_BLAST_10H   = 92455,
    SPELL_LIGHTNING_BLAST_25H   = 92456,
    SPELL_LIGHTNING_ROD            = 83099,
    SPELL_THUNDERSHOCK            = 83067,
    SPELL_THUNDERSHOCK_25        = 92469,
    SPELL_THUNDERSHOCK_10H        = 92470,
    SPELL_THUNDERSHOCK_25H        = 92471,
    SPELL_CHAIN_LIGHTNING_DUMMY    = 83300,
    SPELL_CHAIN_LIGHTNING        = 83282,
    SPELL_CHAIN_LIGHTNING_25    = 92448,
    SPELL_CHAIN_LIGHTNING_10H   = 92449,
    SPELL_CHAIN_LIGHTNING_25H   = 92450,
    ...
    SPELL_QUAKE                    = 83565,
    SPELL_QUAKE_25                = 92544,
    SPELL_QUAKE_10H                = 92545,
    SPELL_QUAKE_25H                = 92546,
    ...
    SPELL_GRAVITY_CORE_DMG_25   = 92537,
    SPELL_GRAVITY_CORE_DMG_10H  = 92538,
    SPELL_GRAVITY_CORE_DMG_25H  = 92539,
    ...
    SPELL_ELECTRIC_INSTABILITY_DMG_25    = 92480,
    SPELL_ELECTRIC_INSTABILITY_DMG_10H    = 92481,
    SPELL_ELECTRIC_INSTABILITY_DMG_25H    = 92482,
    SPELL_GRAVITY_CRUSH                    = 84948,
    SPELL_GRAVITY_CRUSH_25                = 92486,
    SPELL_GRAVITY_CRUSH_10H                = 92487,
    SPELL_GRAVITY_CRUSH_25H                = 92488,
    SPELL_GRAVITY_CRUSH_VEHICLE            = 84952,
    SPELL_LIQUID_ICE                    = 84914,
    SPELL_LIQUID_ICE_DMG                = 84915,
    SPELL_LIQUID_ICE_DMG_25                = 92497,
    ...
    public:
        ...
        struct boss_feludiusAI : BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_HYDROLANCE, urand(12000, 15000));
            ...
            void DoAction(const int32 action)
            {
                ...
                case ACTION_PHASE_3:
                    me->NearTeleportTo(
                        ...
                        0.0f);
                    events.ScheduleEvent(EVENT_PHASE_3_3, 9000);
                    break;
                }
            }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_HYDROLANCE:
                        ...
                        events.ScheduleEvent(EVENT_HYDROLANCE, urand(15000, 18000));
                        break;
                    case EVENT_GLACIATE:
                    ...
                    case EVENT_HEART_OF_ICE:
                        ...
                        events.ScheduleEvent(EVENT_HEART_OF_ICE, urand(21000, 24000));
                        break;
                    }
                }
    ...
    public:
        ...
        struct boss_ignaciousAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_FLAME_TORRENT, urand(15000, 30000));
                events.ScheduleEvent(EVENT_AEGIS_OF_FLAMES, urand(30000, 40000));
                events.ScheduleEvent(EVENT_INFERNO_JUMP, urand(20000, 30000));
                //Talk(SAY_IGNACIOUS_AGGRO);
                events.ScheduleEvent(EVENT_IGNACIOUS_INTRO, 4000);
                //instance->SetBossState(DATA_COUNCIL, IN_PROGRESS);
            }
            ...
            void DoAction(const int32 action)
            {
                ...
                case ACTION_PHASE_3:
                    me->NearTeleportTo(
                        ...
                        0.0f);
                    events.ScheduleEvent(EVENT_PHASE_3_4, 14000);
                    break;
                }
            }
                ...
                if (type == POINT_MOTION_TYPE)
                {
                    switch (id)
                    {
                        ...
                        case EVENT_JUMP:
                        {
                            ...
                            events.ScheduleEvent(EVENT_INFERNO_RUSH, 1000);
                            break;
                        }
                    }
                }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_FLAME_TORRENT:
                        ...
                        events.ScheduleEvent(EVENT_FLAME_TORRENT, urand(15000, 23000));
                        break;
                    case EVENT_BURNING_BLOOD:
                        if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 1, 0.0f , true))
                            DoCast(target, SPELL_BURNING_BLOOD);
                        events.ScheduleEvent(EVENT_BURNING_BLOOD, urand(21000, 24000));
                        break;
                    case EVENT_AEGIS_OF_FLAMES:
                        Talk(SAY_IGNACIOUS_SPELL);
                        DoCast(me, SPELL_AEGIS_OF_FLAMES);
                        events.ScheduleEvent(EVENT_AEGIS_OF_FLAMES, 60000);
                        events.ScheduleEvent(EVENT_RISING_FLAMES, 1000);
                        break;
        ...
        struct boss_arionAI : public BossAI
        {
            ...
            void DoAction(const int32 action)
            {
                ...
                case ACTION_PHASE_2:
                    ...
                    events.ScheduleEvent(EVENT_ARION_INTRO, 1000);
                    me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                    SetCombatMovement(true);
                    events.ScheduleEvent(EVENT_CALL_WINDS, urand(10000, 11000));
                    events.ScheduleEvent(EVENT_DISPERSE, urand(15000, 20000));
                    events.ScheduleEvent(EVENT_LIGHTNING_ROD, urand(20000, 30000));
                    break;
                case ACTION_THUNDERSHOCK:
                    events.ScheduleEvent(EVENT_THUNDERSHOCK, urand(30000, 34000));
                    break;
                case ACTION_PHASE_3:
                    bPhaseThree = true;
                    summons.DespawnAll();
                    ...
                    me->NearTeleportTo(
                        ...
                        0.0f);
                    events.ScheduleEvent(EVENT_PHASE_3_1, 2000);
                    break;
                }
            }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_CALL_WINDS:
                        ...
                        events.ScheduleEvent(EVENT_CALL_WINDS, urand(20000, 30000));
                        break;
                    case EVENT_DISPERSE:
                    ...
                    case EVENT_LIGHTNING_ROD:
                        ...
                        events.ScheduleEvent(EVENT_LIGHTNING_ROD, urand(25000, 30000));
                        break;
        ...
        struct boss_terrastraAI : public BossAI
        {
            ...
            void DoAction(const int32 action)
            {
                ...
                case ACTION_PHASE_2:
                    ...
                    events.ScheduleEvent(EVENT_TERRASTRA_INTRO, 4000);
                    me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                    SetCombatMovement(true);
                    events.ScheduleEvent(EVENT_HARDEN_SKIN, urand(20000, 30000));
                    events.ScheduleEvent(EVENT_ERUPTION, urand(15000, 20000));
                    events.ScheduleEvent(EVENT_GRAVITY_WELL, urand(20000, 30000));
                    events.ScheduleEvent(EVENT_QUAKE, urand(30000, 35000));
                    break;
                case ACTION_QUAKE:
                    events.ScheduleEvent(EVENT_QUAKE, urand(30000, 34000));
                    break;
                case ACTION_PHASE_3:
                    bPhaseThree = true;
                    events.Reset();
                    ...
                    me->NearTeleportTo(
                        ...
                        0.0f);
                    events.ScheduleEvent(EVENT_PHASE_3_2, 6000);
                    break;
                }
            }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_HARDEN_SKIN:
                        ...
                        events.ScheduleEvent(EVENT_HARDEN_SKIN, urand(40000, 50000));
                        break;
                    case EVENT_ERUPTION:
                        DoCast(me, SPELL_ERUPTION_DUMMY);
                        events.ScheduleEvent(EVENT_ERUPTION, urand(13000, 16000));
                        break;
    ...
    public:
        ...
        struct boss_elementium_monstrosityAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_GRAVITY_CRUSH, urand(7000, 20000));
                events.ScheduleEvent(EVENT_LAVA_SEED, urand(8000, 15000));
            }
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_GRAVITY_CRUSH:
                        ...
                        events.ScheduleEvent(EVENT_GRAVITY_CRUSH, urand(22000, 24000));
                        break;
