...
{
    public:
        WhelpCheck(WorldObject const* obj, uint32 entry, uint64 guid) : i_obj(obj), i_entry(entry), i_guid(guid) {}
...
{
    public:
        TwilightSlicerTargetSelector(WorldObject* caster, WorldObject* target) : i_caster(caster), i_target(target) { }
