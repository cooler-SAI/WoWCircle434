...
class npc_ritual_tiki_mask : public CreatureScript
{
    public:
        ...
        {
            return GetZulGurubAI<npc_ritual_tiki_maskAI>(creature);
        }
};
...
class npc_cache_of_madness_artifact : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return GetZulGurubAI<npc_cache_of_madness_artifactAI>(creature);
        }
};
class npc_cache_of_madness_artifact_active : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return GetZulGurubAI<npc_cache_of_madness_artifact_activeAI>(creature);
        }
};
void AddSC_zulgurub()
{
