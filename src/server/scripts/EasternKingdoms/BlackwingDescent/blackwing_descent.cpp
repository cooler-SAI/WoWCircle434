...
public:
    ...
    struct npc_flash_bombAI : public Scripted_NoMovementAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_FLASH_BOMB_DMG, 3000);
        }
...
public:
    ...
    struct npc_laser_strikeAI : public Scripted_NoMovementAI
    {
        ...
        void IsSummonedBy(Unit* owner)
        {
            events.ScheduleEvent(EVENT_LASER_STRIKE_DMG, 3000);
        }
...
public:
    ...
    struct npc_drakonid_drudgeAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_DRAKONID_RUSH, 12000);
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_THUNDERCLAP:
                    ...
                    events.ScheduleEvent(EVENT_THUNDERCLAP, urand(15000, 17000));
                    break;
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CONSTRICTING_CHAINS:
                    ...
                    events.ScheduleEvent(EVENT_CONSTRICTING_CHAINS, urand(14000, 18000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MAIMGOR_BERSERK:
                    ...
                    events.ScheduleEvent(EVENT_MAIMGOR_BERSERK, urand(20000, 25000));
                    break;
                case EVENT_TAIL_LASH:
                    DoCast(me, SPELL_TAIL_LASH);
                    events.ScheduleEvent(EVENT_TAIL_LASH, urand(5000, 6000));
                    break;
                case EVENT_SHADOWFLAME:
                    DoCast(me, SPELL_SHADOWFLAME);
                    events.ScheduleEvent(EVENT_SHADOWFLAME, urand(12000, 20000));
                    break;
                case EVENT_PIERCING_GRIP:
                    DoCast(me->getVictim(), SPELL_PIERCING_GRIP);
                    events.ScheduleEvent(EVENT_PIERCING_GRIP, urand(15000, 20000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CURSE_OF_MENDING:
                    ...
                    events.ScheduleEvent(EVENT_CURSE_OF_MENDING, urand(15000, 17000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_BLAST_WAVE:
                    ...
                    events.ScheduleEvent(EVENT_BLAST_WAVE, urand(15000, 20000));
                    break;
                case EVENT_CLEAVE:
                ...
                case EVENT_MORTAL_STRIKE:
                    ...
                    events.ScheduleEvent(EVENT_MORTAL_STRIKE, urand(12000, 15000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct npc_drakeadon_mongrelAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_IGNITE_FLESH, urand(20000, 30000));
            events.ScheduleEvent(EVENT_TIME_LAPSE, urand(10000, 30000));
            events.ScheduleEvent(EVENT_CORROSIVE_ACID, urand(6000, 10000));
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MONGREL_CHARGE:
                    ...
                    events.ScheduleEvent(EVENT_MONGREL_CHARGE, urand(12000, 15000));
                    break;
                case EVENT_IGNITE_FLESH:
                    DoCast(SPELL_IGNITE_FLESH);
                    events.ScheduleEvent(EVENT_IGNITE_FLESH, urand(30000, 40000));
                    break;
                case EVENT_FROST_BURN:
                    ...
                    events.ScheduleEvent(EVENT_FROST_BURN, urand(15000, 30000));
                    break;
                case EVENT_INSENERATE:
                    ...
                    events.ScheduleEvent(EVENT_INSENERATE, urand(15000, 30000));
                    break;
                case EVENT_TIME_LAPSE:
                    ...
                    events.ScheduleEvent(EVENT_TIME_LAPSE, urand(15000, 30000));
                    break;
                case EVENT_CORROSIVE_ACID:
                    DoCast(me, SPELL_CORROSIVE_ACID);
                    events.ScheduleEvent(EVENT_CORROSIVE_ACID, urand(20000, 30000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_SHADOW_INFUSION:
                        ...
                        RAID_MODE(SPELL_LIGHTNING_CONDUCTOR, SPELL_LIGHTNING_CONDUCTOR_25, SPELL_LIGHTNING_CONDUCTOR_10H, SPELL_LIGHTNING_CONDUCTOR_25H)))
                    {
                        ...
                        pTarget->RemoveAurasDueToSpell(SPELL_LIGHTNING_CONDUCTOR_25);
                        pTarget->RemoveAurasDueToSpell(SPELL_LIGHTNING_CONDUCTOR_10H);
                        pTarget->RemoveAurasDueToSpell(SPELL_LIGHTNING_CONDUCTOR_25H);
