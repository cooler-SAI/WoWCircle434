...
public:
    ...
    static bool HandleServerInfoCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        handler->PSendSysMessage("WoW Circle Core: Last Update: 15.04.2013 Updatepack: 10");
        handler->PSendSysMessage("WoW Circle DB: Last Update: 15.04.2013 Updatepack: 47");
