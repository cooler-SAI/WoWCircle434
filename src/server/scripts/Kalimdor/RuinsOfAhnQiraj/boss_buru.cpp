...
public:
    ...
    struct npc_buru_eggAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* attacker)
        {
            ...
            if (Creature* buru = me->GetMap()->GetCreature(me->GetInstanceScript()->GetData64(DATA_BURU)))
            if (!buru->isInCombat())
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            me->CastSpell(me, SPELL_EXPLODE_2, true); // Unknown purpose
            me->CastSpell(me, SPELL_SUMMON_HATCHLING, true);
