        ...
        void MoveInLineOfSight(Unit* who)
        {
            ...
            if (who->IsWithinDistInMap(me, 10.0f) && !who->HasAura(SPELL_SLIPSTREAM_BUFF))
            {
                ...
                case 470660:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-82.05f, 1019.41f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470661:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-263.82f, 840.92f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470662:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-81.59f, 607.18f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470663:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-261.84f, 790.64f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470664:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(158.55f, 783.50f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470665:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-20.90f, 606.96f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470666:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(-16.75f, 1022.54f, 199.49f, 75.0f, 25.0f);
                    break;
                case 470667:
                    me->AddAura(SPELL_SLIPSTREAM_BUFF, who);
                    me->AddAura(SPELL_SLIPSTREAM_PLAYER_VISUAL, who);
                    who->GetMotionMaster()->MoveJump(157.76f, 844.96f, 199.49f, 75.0f, 25.0f);
                    break;
                }
            }
        }
