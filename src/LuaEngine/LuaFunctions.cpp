...
void RegisterGlobals(lua_State* L)
{
    ...
    lua_register(L, "AddVendorItem", &LuaGlobalFunctions::AddVendorItem);                                   // AddVendorItem(entry, itemId, maxcount, incrtime, extendedcost, type [, persist(bool)]) - Adds an item to vendor entry. If persist is false, wont be saved to database.
...
ElunaRegister<Unit> UnitMethods[] =
{
    ...
    {"GetCurrency", &LuaUnit::GetCurrency},                                                                 // :GetCurrency(currency)
    ...
    {"SetCurrency", &LuaUnit::SetCurrency},                                                                 // :SetCurrency(id, count)
    ...
    {"ModifyMoney", &LuaUnit::ModifyMoney},                                                                 // :ModifyMoney(amount) - Modifies (does not set) money (copper count) of the player. Amount can be negative to remove copper
    ...
    {"CastedCreatureOrGO", &LuaUnit::CastedCreatureOrGO},                                                   // :CastedCreatureOrGO(Entry, GUID, spellId) - Credits the player for destroying a GO, guid is optional
    ...
    {"ModifyCurrency", &LuaUnit::ModifyCurrency},                                                           // :ModifyCurrency(currency, amount) - Modifies the player's arena points
    ...
    {"HandleGameObject", &LuaUnit::HandleGameObject},                                                       // :HandleGameObject(go, open) -- UNDOCUMENTED
    { NULL, NULL },
};
