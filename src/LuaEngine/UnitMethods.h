...
namespace LuaUnit
{
    ...
    int ModifyCurrency(lua_State*, Unit*);
    ...
    int GetSpawnMode(lua_State*, Unit*);
    ...
    int GetCurrency(lua_State*, Unit*);
    ...
    int SetCurrency(lua_State*, Unit*);
    ...
    int HandleGameObject(lua_State*, Unit*);
